                  ...
                  {isBooked ? (
                    ...
                    >
                      ...
                      <p className="text-stone-500 leading-relaxed max-w-sm mx-auto mb-10 text-lg font-light">
                        Your reservation request for that room has been logged. We will reach out to you shortly with availability and payment details.
                      </p>
                      <button
                    ...
                    >
                      ...
                      <div className="space-y-3">
                         ...
                         >
                            ...
                            {rooms.map(room => (
                              <option key={room.id} value={room.name}>{room.name} — RWF {room.price.toLocaleString()}/night</option>
                            ))}
                         </select>
                      </div>
                      ...
                      >
                         {isSubmitting ? <Loader2 size={18} className="animate-spin" /> : <><Hotel size={18} /> Check Availability</>}
                      </button>
                    </motion.form>
                  )}
                </AnimatePresence>
